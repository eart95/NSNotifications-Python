...
async def trigger_extreme_high_bg_alert(bg):
    ...
    for device_token in DEVICE_TOKENS:
        #print(device_token)
        await send_push_notification(device_token, '🔴 Very high blood sugar', f'Your blood sugar is {int(bg)} mg/dL.')

async def trigger_extreme_low_bg_alert(bg):
    print("Extreme Low BG Alert Triggered")
    for device_token in DEVICE_TOKENS:
        #print(device_token)
        await send_push_notification(device_token, '🆘 VERY LOW blood sugar', f'Your blood sugar is {int(bg)} mg/dL.')

async def trigger_high_bg_alert(bg):
    print("High BG Alert Triggered")
    for device_token in DEVICE_TOKENS:
        #print(device_token)
        await send_push_notification(device_token, '🟡 High blood sugar', f'Your blood sugar is {int(bg)} mg/dL.')
...
async def trigger_time_in_range_alert(bg):
    ...
    for device_token in DEVICE_TOKENS:
        #print(device_token)
        await send_push_notification(device_token, '🟠 Blood sugar has been out of range', f'Currently, your blood sugar is {int(bg)} mg/dL.')
